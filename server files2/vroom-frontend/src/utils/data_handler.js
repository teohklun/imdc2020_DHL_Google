...
var addVehicle = function(v) {
  // console.log("enter add vehicle");
  _clearSolution();
  // console.log("enter add vehicle after clear");
  data.vehicles.push(v);
  // console.log("vehicle add" + v.id );
  ...
  if (!vTable) {
    ...
    titleName.appendChild(document.createTextNode(v.id.toString() + " ) Name: " + v.name  ));
...
var markUnassigned = function(unassigned) {
  console.log("mark unassigned");
  //console.log(unassigned);
  // Object.keys(unassigned).forEach(function(k){
  //   data.jobsMarkers[unassigned[k].id.toString()]
  //     .setStyle({
  ...
  // if(unassigned.constructor.name == Array){
...
var addGeometries = function(resultRoutes) {
  console.log("add addGeometries start");
  console.log("result rotues : " + resultRoutes.length);
...
var addRoutes = function(resultRoutes) {
  ...
  for (var i = 0; i < resultRoutes.length; ++i) {
    ...
    console.log("before solution list");
...
var setData = function(data) {
  ...
  //   // console.log(vehicle);
  //   // console.log('first for each vehicles');
  //   addVehicle(vehicle);
  // });

  console.log("after first setdata loop");
  ...
  console.log("after second setdata loop");
